...
var _dataTest = __webpack_require__(334);

var _dataTest2 = _interopRequireDefault(_dataTest);
...
function runApp() {
    console.log(_dataTest2.default);
    var showNewsBtn = document.querySelector('#show-news');
    ...
    function showNewsClick() {
        ...
        loadAppModule();
        setTimeout(function () {
            return showNewsBtn.parentNode.removeChild(showNewsBtn);
        }, 4000);
    }

    function loadAppModule() {
        __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 335)).then(function (module) {
            var startApp = module.default;
            startApp();
        });
    }
}
...
module.exports = {"article":{"title":"test","page":"2","year":"2015","complex":{"someArray":[1,2,{"a":"doNotRemoveThis"},4],"someObj":{"name":"simpleStringProperty"}}}}
